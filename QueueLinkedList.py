...
class LinkedList:
	...
	# If linked list is empty end
    def delete(self):
        # If linked list is empty
        if self.head == None:
            return False
        # Store head node as current
        current = self.head
        #replacing head element with the first one
...
print "Delete the first element from the linked list"
ll.delete()

print "Display the linked list again. The first value was deleted. "
ll.display()
