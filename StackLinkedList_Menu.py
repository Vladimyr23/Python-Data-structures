...
class LinkedList:
    ...
    def delete(self):
        ...
        #Next 3 lines to delete the last element
        elif current.next == None:
            print self.head, "Item removed"
            self.head = None
    ...
    def display(self):
        ...
        #Next two lines to display that the list is empty
        if current == None:
            print ("The stack linked list is empty")
        else:
		  while current != None:
